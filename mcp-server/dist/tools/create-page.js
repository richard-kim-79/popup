...
export function registerCreatePage(server) {
    server.tool('create_page', 'Create a new Popup web page from an array of blocks. Returns the slug, public URL, and edit PIN. Save the PIN — it is required to edit the page later.', {
    ...
    }, { readOnlyHint: false, destructiveHint: false }, async ({ blocks, pin }) => {
